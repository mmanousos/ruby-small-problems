...
Algorithm
  BEGIN
    array from argument
    iterate over elements in array yielding each to yet to be provided block
    if any of the block evaluations is `true`, break and return true
    otherwise continues evaluation
    returns false
  END
