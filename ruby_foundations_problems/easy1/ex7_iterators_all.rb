...
any Enumerable collection). In this exercise, you will develop its companion,
all?.
...
Algorithm
  BEGIN
    ...
    iterate over collection yielding each element to the block
    break if evaluation is false
    otherwise true
  END
