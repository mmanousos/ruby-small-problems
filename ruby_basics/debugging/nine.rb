...
# When each value is multiplied by 0, the original value of 'product', they are converted to 0, so the final product will = 0.
# by changing 'products' initial assignment to 1, the error is corrected. 
