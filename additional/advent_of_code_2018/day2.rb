...
Out: integer that represents the product of all strings with the same letter 
exactly two times and those with the same letter exactly three times

Approach Brainstorming: 
use regex to check for 2 of same letter: /.*([a-z]).*\1.*/
use regex to check for 3 of same letter: /.*([a-z]).*\1.*\1.*/
