...
class CryptoTest < Minitest::Test
  ...
  def test_another_normalized_ciphertext
    ...
    expected_plaintext = ['ifmanwas', 'meanttos', 'tayonthe', 'groundgo', 'dwouldha', 'vegivenu', 'sroots']
    assert_equal expected_plaintext, crypto.plaintext_segments

    expected_cipher = 'imtgdvs fearwer mayoogo anouuio ntnnlvt wttddes aohghn sseoau'
    assert_equal expected_cipher, crypto.normalize_ciphertext
  end
