...
class SumTest < Minitest::Test
  ...
  def test_error_number_is_string
    # skip
    assert_raises(ArgumentError) do
      SumOfMultiples.new(43, 47).to('happy')
    end
  end

  def test_error_number_is_float
    # skip
    assert_raises(ArgumentError) do
      SumOfMultiples.new(43, 47).to(4.7)
    end
  end

  def test_error_number_is_negative
    # skip
    assert_raises(ArgumentError) do
      SumOfMultiples.new(43, 47).to(-5)
    end
  end
end
