...
# in: string of commands including words and integers
# out: integer or nil depending on the commands


# AL: split string into array and iterate over array evaluating each element
# SET register = 0
# SET stack = [] to hold values in order provided - new items pushed and popped from the end
# use case statement to execute operations in sequence
